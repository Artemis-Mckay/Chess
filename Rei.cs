...
public class Rei : Pecas
{
    public Rei(string cor, int linha, int coluna) : base(cor, linha, coluna)
    {
        ...
        try
        {
            string path = Path.Combine($@"{disk}:\Users\", Environment.UserName, "Chess", "bin", "Debug", "imagens", $"rei_{cor}.png"); // Se estiver dando erro, edite o valor da variável 'disk' para "D"
