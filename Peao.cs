...
public class Peao : Pecas
{
    ...
    public Peao(string Cor, int Linha, int Coluna) : base(Cor, Linha, Coluna)
    {
        ...
        try
        {
            string path = Path.Combine($@"{disk}:\Users\", Environment.UserName, "Chess", "bin", "Debug", "imagens", $"peao_{cor}.png"); // Se estiver dando erro, edite o valor da variável 'disk' para "D"
