...
public class Rainha : Pecas
{
    ...
    public Rainha(string cor, int linha, int coluna) : base(cor, linha, coluna)
    {
        ...
        try
        {
            string path = Path.Combine($@"{disk}:\Users\", Environment.UserName, "Chess", "bin", "Debug", "imagens", $"dama_{cor}.png"); // Se estiver dando erro, edite o valor da variável 'disk' para "D"
